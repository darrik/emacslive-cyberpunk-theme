...
;;
;;
;; Emacs 24 port by Rikard Glans (rikard@ecx.se)
;; Time-stamp: <2013-03-11 19:21:11>

(unless (>= 24 emacs-major-version)
  (error "emacslive-cyberpunk requires Emacs 24 or later."))

(deftheme emacslive-cyberpunk
...
(provide-theme 'emacslive-cyberpunk)
